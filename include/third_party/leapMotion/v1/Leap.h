...
public:
    ...
    LEAP_EXPORT Vector intersect(const Vector& position,
...
public:
     ...
     * @since 2.2.7
     */
    void* dataPointer() const { return (void*)data(); }

    /* Do not call distortionPointer(). It is intended only as a helper for C#.
     *
     * @since 2.2.7
     */
    void* distortionPointer() const { return (void*)distortion(); }
...
{
public:
    ConstListIterator<L, T>()
        : m_list(0)
        , m_index(-1)
    {
    }
    ConstListIterator<L, T>(const L& list, int index)
        : m_list(&list)
        , m_index(index)
    {
    }
...
public:
     ...
     * @since 2.1.0
     */
    void deserialize(const std::string& str) { deserializeCString(str.data(), str.length()); }
...
public:
     ...
     * @since 1.0
     */
    ValueType type(const std::string& key) const { return typeCString(key.c_str()); }
     ...
     * @since 1.0
     */
    bool getBool(const std::string& key) const { return getBoolCString(key.c_str()); }
     ...
     * @since 1.0
     */
    bool setBool(const std::string& key, bool value) { return setBoolCString(key.c_str(), value); }
     ...
     * @since 1.0
     */
    int32_t getInt32(const std::string& key) const { return getInt32CString(key.c_str()); }
     ...
     * @since 1.0
     */
    bool setInt32(const std::string& key, int32_t value) { return setInt32CString(key.c_str(), value); }
     ...
     * @since 1.0
     */
    float getFloat(const std::string& key) const { return getFloatCString(key.c_str()); }
     ...
     * @since 1.0
     */
    bool setFloat(const std::string& key, float value) { return setFloatCString(key.c_str(), value); }
